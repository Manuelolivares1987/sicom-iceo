-- ROLLBACK MIG189 v2 — EMERGENCIA. REABRE escritura anónima no validada.
...
GRANT EXECUTE ON FUNCTION public.rpc_checklist_cliente_guardar(p_payload jsonb) TO anon;
...
GRANT EXECUTE ON FUNCTION public.rpc_guardar_checklist_publico(p_payload jsonb) TO anon;
