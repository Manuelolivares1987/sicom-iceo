...
CREATE OR REPLACE FUNCTION public.fn_reporte_fiabilidad_publico(p_ini date DEFAULT (date_trunc('month'::text, (CURRENT_DATE)::timestamp with time zone))::date, p_fin date DEFAULT CURRENT_DATE)
 RETURNS jsonb
 LANGUAGE sql
