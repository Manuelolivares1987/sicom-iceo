-- ============================================================================
-- SICOM-ICEO | 116 — Fix rpc_crear_ot: orden de checklist secuencial
-- ============================================================================
-- Bug: al copiar el checklist (de pauta o template) a checklist_ot, el orden
-- venía del JSON (item->>'orden'), que podía repetirse al castear a INTEGER →
-- violaba UNIQUE(ot_id, orden) y bloqueaba la creación de la OT.
-- Fix: asignar el orden SECUENCIAL con WITH ORDINALITY (1,2,3...), independiente
-- del campo 'orden' del template. (Incluye el permiso de 'fuera_servicio' de MIG115.)
-- ============================================================================
...
DO $$ BEGIN RAISE NOTICE 'MIG116 OK: rpc_crear_ot usa orden secuencial (WITH ORDINALITY)'; END $$;
