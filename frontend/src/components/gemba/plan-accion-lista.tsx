...
// La lista de gestión del plan de acción Gemba, compartida entre la bandeja
// (/dashboard/gemba/hallazgos) y el reporte de avance — Manuel: «necesito que
// se vea aquí [en el reporte]». Un solo componente para que la gestión sea la
// misma en las dos páginas.

import { useMemo, useState } from 'react'
import Link from 'next/link'
import {
  Pencil, CheckCircle2, RotateCcw, PlayCircle, Footprints, Camera,
} from 'lucide-react'
...
export const estaVencido = (h: GembaHallazgo) =>
...
export function HallazgoCard({ h }: { h: GembaHallazgo }) {
...
/** Lista completa con filtros: la misma gestión en la bandeja y en el reporte. */
export function PlanAccionLista() {
