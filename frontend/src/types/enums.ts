...
export type RolUsuario = 'administrador' | 'gerencia' | 'subgerente_operaciones' | 'supervisor' | 'planificador' | 'tecnico_mantenimiento' | 'bodeguero' | 'operador_abastecimiento' | 'auditor' | 'rrhh_incentivos' | 'jefe_operaciones' | 'jefe_mantenimiento' | 'comercial' | 'prevencionista' | 'colaborador' | 'auditor_calidad' | 'operador_taller' | 'operador_combustible'
