      ...
      <Card className="max-w-md w-full text-center">
        <CardContent className="pt-8 pb-8">
          <div className="mx-auto w-16 h-16 rounded-full bg-pillado-green-50 flex items-center justify-center mb-4">
            <Settings className="w-8 h-8 text-pillado-green-500" />
          </div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Administración</h1>
          <p className="text-gray-500 mb-4">Gestión de usuarios, roles, permisos, parámetros del sistema y configuración de KPI/ICEO.</p>
